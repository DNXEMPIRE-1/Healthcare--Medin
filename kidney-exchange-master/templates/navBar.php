        ...
        <?php
          if (isset($_SESSION['userId'])) {
            ...
            echo '<li class="nav-item">
                  <a class="nav-link" href="/medin/Healthcare-Website-master/kidney-exchange-master/pages/login.php">Login</a>
                  </li>';
            echo '<li class="nav-item">
                  <a class="nav-link" href="/medin/Healthcare-Website-master/kidney-exchange-master/pages/signup.php">Sign Up</a>
                  </li>';
